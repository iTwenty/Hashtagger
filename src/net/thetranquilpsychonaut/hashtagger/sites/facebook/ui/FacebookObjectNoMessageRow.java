 ...
 */
public class FacebookObjectNoMessageRow extends SitesListRow
{
    ...
    protected FacebookObjectNoMessageRow( Context context )
    {
        super( context );
    }

    protected FacebookObjectNoMessageRow( Context context, AttributeSet attrs )
    {
        super( context, attrs );
    }

    protected FacebookObjectNoMessageRow( Context context, AttributeSet attrs, int defStyle )
    {
    ...
    {
        inflate( context, R.layout.facebook_object_no_message_row, this );
