 ...
 */
public class SitesAdapter extends ArrayPagerAdapter<SitesFragment> implements IconPagerAdapter
{
...
//        PageDescriptor descriptor = getExistingFragment( position ).getPageDescriptor();
