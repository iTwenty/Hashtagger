 ...
 */
public class StatusDetailActivity extends SavedHashtagsActivity
{
    ...
    protected void onCreate( Bundle savedInstanceState )
    {
        ...
        RelativeLayout rl = ( RelativeLayout ) getLayoutInflater().inflate( R.layout.activity_status_detail, null, false );
