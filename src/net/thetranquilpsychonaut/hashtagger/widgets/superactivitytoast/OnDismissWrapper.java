 ...
 */
public class OnDismissWrapper implements Listeners.OnDismissListener
{

    private final String                      mTag;
    private final Listeners.OnDismissListener mOnDismissListener;
     ...
     */
    public OnDismissWrapper( String tag, Listeners.OnDismissListener onDismissListener )
    {
