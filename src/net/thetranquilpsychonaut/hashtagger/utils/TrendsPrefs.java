...
public class TrendsPrefs
{
    ...
    public static final String TRENDING_CHOICE         = "trending_choice";
    ...
    public static void addTrends( List<String> trends )
    {
        getTrendsPrefs().edit()
    ...
    public static int getTrendingChoice()
    {
        return getTrendsPrefs().getInt( TRENDING_CHOICE, TwitterTrendsService.LOCAL );
    }

    public static void addTrendingChoice( int choice )
    {
        getTrendsPrefs().edit()
                .putInt( TRENDING_CHOICE, choice )
                .commit();
    }
}
